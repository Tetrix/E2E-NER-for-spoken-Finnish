...
from model import EncoderSwedish, Decoder
...
if __name__ == '__main__':
    ...
    target_test = prepare_data.load_transcripts('../../TSD/augmented_labels/data/normalized/augmented/swedish/test.txt')
    ...
    # load the model
    checkpoint = torch.load('weights/swedish/state_dict_21.pt', map_location=torch.device('cpu'))
