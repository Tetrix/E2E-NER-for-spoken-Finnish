...
if __name__ == '__main__':
    ...
    target_test = prepare_data.load_transcripts('../../TSD/augmented_labels/data/normalized/transcripts/libri/test_clean.txt')
    tags_test = prepare_data.load_tags('../../TSD/augmented_labels/data/normalized/ner/libri/ner_test_clean.txt')
